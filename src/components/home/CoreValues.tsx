export default function CoreValues() {
  ...
  return (
    <section className="py-12 sm:py-16 bg-white border-b border-[#eaeaea]">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {values.map((v, i) => (
            <div
              key={i}
              className="bg-[#fafafa] p-6 sm:p-8 rounded-lg border border-[#eaeaea] text-center flex flex-col items-center justify-center space-y-2 hover:border-[#111] transition-colors"
            >
