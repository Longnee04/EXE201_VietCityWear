  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-product overflow-hidden bg-[#f5f5f5] mb-3">
        ...
        >
          <div className="w-full h-full bg-gradient-to-br from-[#e8e8e8] to-[#d8d8d8] flex items-center justify-center">
            <span className="text-[#bbb] text-xs tracking-wider uppercase font-medium">
              {product.name}
            </span>
          </div>
        </div>
        ...
        >
          {!quickAddOpen ? (
            <button
              ...
              className="w-full bg-[#111]/90 backdrop-blur-sm text-white text-[11px] font-semibold tracking-[0.12em] uppercase py-3.5 hover:bg-[#111] transition-colors"
            >
              QUICK ADD
            </button>
          ) : (
        ...
        <button
          ...
          className="lg:hidden absolute bottom-3 right-3 z-10 w-8 h-8 bg-white border border-[#ddd] flex items-center justify-center shadow-sm"
        >
